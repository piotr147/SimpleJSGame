...
var dist;
var obsUp = myHeight / 2 - borderHeight / 2 - obstacleHeight;
var obsDown = myHeight / 2 + borderHeight / 2;
...
var coinsScore = 0;
var coinsMissed = 0;
var coinUp = myHeight / 2 - borderHeight / 2 - coinSize;
var coinDown = myHeight / 2 + borderHeight / 2;
...
function startGame() {
    ...
    myCoinsMissedText = new component("30px", "Consolas", "black", 100, 150, "text");
    ...
    if(!gameEnd) {
        ...
        if (distCoin <= 0) {
            ...
            if(rand)
                ...
                y = coinDown;
            myCoins.push(new component(coinSize, coinSize, "#e6b800", x, y));  
        }
        ...
        if(myGameArea.frameNo <= 300)
        {
            ...
            instruction.text = "Click on the screen to change position, avoid obstacles and collect coins";
            instruction.update();
        }
